...
ko.bindingHandlers.linechart = {
  init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
    ...
    bucket.width = (ko.unwrap(allBindings.get('width')) - 0) || 750;
    bucket.height = (ko.unwrap(allBindings.get('height')) - 0) || 350;
    bucket.duration = (ko.unwrap(allBindings.get('duration')) - 0) || 1000;
    bucket.limit = 60;
